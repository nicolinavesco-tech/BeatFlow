        ...
        <main>
            ...
            <section class="min-h-screen flex bg-black justify-center items-start pt-10 lg:pt-20 gap-2">
                ...
                <div class="flex rounded-xl border border-base-100 w-full min-w-0 bg-base-100 flex-col gap-6 min-h-screen p-5 md:p-8">
                    ...
                    <div class="p-4 mb-3 rounded bg-gray-800 text-white flex gap-4 items-center">

                        <img src="{{ $track['image'] }}" nalt="{{ $track['name'] }}" class="w-20 h-20 object-cover rounded">

                        <div class="flex-1">
                            <h2 class="text-lg font-semibold">{{ $track['name'] }}</h2>
                            <p class="text-gray-300">{{ __('ui.artist') }}: {{ $track['artist_name'] }}</p>
                            <p class="text-gray-400 text-sm">{{ __('ui.album') }}: {{ $track['album_name'] ?? 'Nessun album' }}</p>
                    ...
                    @empty
                    <p class="text-white">{{ __('ui.no_results') }}</p>
                    @endforelse
                </div>
            </section>
        </main>
