<main class="container-fluid">
    ...
    <section class="min-h-screen flex bg-black justify-center items-start pt-20 gap-2">
        ...
        <div class="flex rounded-xl border border-base-100 w-full min-w-0 bg-base-100 flex-col gap-6 pt-20">
                <h2 class="text-3xl md:text-5xl text-white font-bold text-center">Scarica l'app di BeatFlow</h2>
                <p class="text-white text-center max-w-2xl">Ascolta la tua musica preferita ovunque tu sia. Scarica l'app di BeatFlow per un'esperienza musicale senza interruzioni su tutti i tuoi dispositivi.</p>
                <div class="flex gap-4 justify-center">
                    <a href="{{ route('download') }}" class="btn bg-white text-black rounded-3xl font-bold">Scarica ora</a>
                </div>
        </div>
