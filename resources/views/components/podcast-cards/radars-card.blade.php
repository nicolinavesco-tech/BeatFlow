...
<div class="group shrink-0 w-36 sm:w-40 md:w-44 xl:w-52 flex flex-col relative hover:bg-slate-700/55 rounded-lg p-2 transition">
    <a href="" class="block">
        <img src="{{ $image }}" alt="{{ $title }}" class="w-full aspect-square rounded-lg object-cover">
