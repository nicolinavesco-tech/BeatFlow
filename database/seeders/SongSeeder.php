...
class SongSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $songs = [
            ...
            ['title' => 'Tokyo Drift', 'artist' => 'Skai IsYourGod', 'artist_id' => $skai?->id, 'file_path' => 'songs/skai.mp3', 'image_path' => 'media/skyisyourgod/tokyodrift.jpg', 'genre_id' => $rap?->id],
            ['title' => 'Samurai Flow', 'artist' => 'Skai IsYourGod', 'artist_id' => $skai?->id, 'file_path' => 'songs/skai.mp3', 'image_path' => 'media/skyisyourgod/samuraiflow.jpg', 'genre_id' => $rap?->id],
            ['title' => 'Neon City', 'artist' => 'Skai IsYourGod', 'artist_id' => $skai?->id, 'file_path' => 'songs/skai.mp3', 'image_path' => 'media/skyisyourgod/neoncity.webp', 'genre_id' => $rap?->id],
            ['title' => 'Katana', 'artist' => 'Skai IsYourGod', 'artist_id' => $skai?->id, 'file_path' => 'songs/skai.mp3', 'image_path' => 'media/skyisyourgod/katana.webp', 'genre_id' => $rap?->id],
            ['title' => 'Shibuya Nights', 'artist' => 'Skai IsYourGod', 'artist_id' => $skai?->id, 'file_path' => 'songs/skai.mp3', 'image_path' => 'media/skyisyourgod/shibuyanights.jpg', 'genre_id' => $rap?->id],
            ['title' => 'Dragon Flow', 'artist' => 'Skai IsYourGod', 'artist_id' => $skai?->id, 'file_path' => 'songs/skai.mp3', 'image_path' => 'media/skai.jpg', 'genre_id' => $rap?->id],
            ['title' => 'Zen Mode', 'artist' => 'Skai IsYourGod', 'artist_id' => $skai?->id, 'file_path' => 'songs/skai.mp3', 'image_path' => 'media/skyisyourgod/zen.jpg', 'genre_id' => $rap?->id],
            ...
            ['title' => 'Water', 'artist' => 'Tyla', 'artist_id' => $tyla?->id, 'file_path' => 'songs/tyla.mp3', 'image_path' => 'media/tyla/water.jpg', 'genre_id' => $pop?->id],
            ['title' => 'Truth or Dare', 'artist' => 'Tyla', 'artist_id' => $tyla?->id, 'file_path' => 'songs/tyla.mp3', 'image_path' => 'media/tyla/truthordare.jpg', 'genre_id' => $pop?->id],
            ['title' => 'Been Thinking', 'artist' => 'Tyla', 'artist_id' => $tyla?->id, 'file_path' => 'songs/tyla.mp3', 'image_path' => 'media/tyla/beenthinking.jpg', 'genre_id' => $pop?->id],
            ['title' => 'To Last', 'artist' => 'Tyla', 'artist_id' => $tyla?->id, 'file_path' => 'songs/tyla.mp3', 'image_path' => 'media/tyla/tolast.jpg', 'genre_id' => $pop?->id],
            ['title' => 'Girl Next Door', 'artist' => 'Tyla', 'artist_id' => $tyla?->id, 'file_path' => 'songs/tyla.mp3', 'image_path' => 'media/tyla/girlnextdoor.jpg', 'genre_id' => $pop?->id],
            ['title' => 'On My Body', 'artist' => 'Tyla', 'artist_id' => $tyla?->id, 'file_path' => 'songs/tyla.mp3', 'image_path' => 'media/tyla/onmybody.avif', 'genre_id' => $pop?->id],
            ['title' => 'Jump', 'artist' => 'Tyla', 'artist_id' => $tyla?->id, 'file_path' => 'songs/tyla.mp3', 'image_path' => 'media/tyla/jump.jpg', 'genre_id' => $pop?->id],

            ['title' => 'How You Like That', 'artist' => 'Blackpink', 'artist_id' => $blackpink?->id, 'file_path' => 'songs/blackpink.mp3', 'image_path' => 'media/blackpink/howyoulikethat.png', 'genre_id' => $pop?->id],
            ['title' => 'Kill This Love', 'artist' => 'Blackpink', 'artist_id' => $blackpink?->id, 'file_path' => 'songs/blackpink.mp3', 'image_path' => 'media/blackpink/Blackpink_-_Kill_This_Love.jpg', 'genre_id' => $pop?->id],
            ['title' => 'DDU-DU DDU-DU', 'artist' => 'Blackpink', 'artist_id' => $blackpink?->id, 'file_path' => 'songs/blackpink.mp3', 'image_path' => 'media/blackpink/dududu.jpg', 'genre_id' => $pop?->id],
            ['title' => 'Pink Venom', 'artist' => 'Blackpink', 'artist_id' => $blackpink?->id, 'file_path' => 'songs/blackpink.mp3', 'image_path' => 'media/blackpink/pinkvenom.jpg', 'genre_id' => $pop?->id],
            ['title' => 'Lovesick Girls', 'artist' => 'Blackpink', 'artist_id' => $blackpink?->id, 'file_path' => 'songs/blackpink.mp3', 'image_path' => 'media/blackpink/lovesick.png', 'genre_id' => $pop?->id],
            ['title' => 'Shut Down', 'artist' => 'Blackpink', 'artist_id' => $blackpink?->id, 'file_path' => 'songs/blackpink.mp3', 'image_path' => 'media/blackpink/shutdown.png', 'genre_id' => $pop?->id],
            ['title' => 'Boombayah', 'artist' => 'Blackpink', 'artist_id' => $blackpink?->id, 'file_path' => 'songs/blackpink.mp3', 'image_path' => 'media/blackpink/Blackpink_-_Boombayah.jpg', 'genre_id' => $pop?->id],

            ['title' => 'Stressed Out', 'artist' => 'Twenty One Pilots', 'artist_id' => $top?->id, 'file_path' => 'songs/top.mp3', 'image_path' => 'media/twentyonepilots/stressedout.jpg', 'genre_id' => $rock?->id],
            ['title' => 'Ride', 'artist' => 'Twenty One Pilots', 'artist_id' => $top?->id, 'file_path' => 'songs/top.mp3', 'image_path' => 'media/twentyonepilots/ride.webp', 'genre_id' => $rock?->id],
            ['title' => 'Heathens', 'artist' => 'Twenty One Pilots', 'artist_id' => $top?->id, 'file_path' => 'songs/top.mp3', 'image_path' => 'media/twentyonepilots/heathens.jpg', 'genre_id' => $rock?->id],
            ['title' => 'Chlorine', 'artist' => 'Twenty One Pilots', 'artist_id' => $top?->id, 'file_path' => 'songs/top.mp3', 'image_path' => 'media/twentyonepilots/chlorine.png', 'genre_id' => $rock?->id],
            ['title' => 'Car Radio', 'artist' => 'Twenty One Pilots', 'artist_id' => $top?->id, 'file_path' => 'songs/top.mp3', 'image_path' => 'media/twentyonepilots/carradio.png', 'genre_id' => $rock?->id],
            ['title' => 'Tear in My Heart', 'artist' => 'Twenty One Pilots', 'artist_id' => $top?->id, 'file_path' => 'songs/top.mp3', 'image_path' => 'media/twentyonepilots/tearinmyheart.jpg', 'genre_id' => $rock?->id],
            ['title' => 'Holding On To You', 'artist' => 'Twenty One Pilots', 'artist_id' => $top?->id, 'file_path' => 'songs/top.mp3', 'image_path' => 'media/twentyonepilots/holdingontoyou.jpg', 'genre_id' => $rock?->id],

            ['title' => 'Tek Tek', 'artist' => 'Dystinct', 'artist_id' => $dystinct?->id, 'file_path' => 'songs/dystinct.mp3', 'image_path' => 'media/dystinct/tektek.jpg', 'genre_id' => $pop?->id],
            ['title' => 'Habiba', 'artist' => 'Dystinct', 'artist_id' => $dystinct?->id, 'file_path' => 'songs/dystinct.mp3', 'image_path' => 'media/dystinct/habiba.jpg', 'genre_id' => $pop?->id],
            ['title' => 'Ghazali', 'artist' => 'Dystinct', 'artist_id' => $dystinct?->id, 'file_path' => 'songs/dystinct.mp3', 'image_path' => 'media/dystinct/ghazali.jpg', 'genre_id' => $pop?->id],
            ['title' => 'Ya Baba', 'artist' => 'Dystinct', 'artist_id' => $dystinct?->id, 'file_path' => 'songs/dystinct.mp3', 'image_path' => 'media/dystinct/yababa.png', 'genre_id' => $pop?->id],
            ['title' => 'Boussa', 'artist' => 'Dystinct', 'artist_id' => $dystinct?->id, 'file_path' => 'songs/dystinct.mp3', 'image_path' => 'media/dystinct/boussa.jpg', 'genre_id' => $pop?->id],
            ['title' => 'Panamera', 'artist' => 'Dystinct', 'artist_id' => $dystinct?->id, 'file_path' => 'songs/dystinct.mp3', 'image_path' => 'media/dystinct/panamera.jpg', 'genre_id' => $pop?->id],
            ['title' => 'Business', 'artist' => 'Dystinct', 'artist_id' => $dystinct?->id, 'file_path' => 'songs/dystinct.mp3', 'image_path' => 'media/dystinct/business.jpg', 'genre_id' => $pop?->id],
