...
class SongSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $songs = [
            ...
            ['title' => 'Pulp Fiction', 'artist' => 'Hatikoali', 'artist_id' => $hatikoali?->id, 'file_path' => 'songs/hatikoali.mp3', 'image_path' => 'media/hatikoali1.jpg', 'duration' => 212, 'genre_id' => $rap?->id],
            ['title' => 'Baribir', 'artist' => 'Hatikoali', 'artist_id' => $hatikoali?->id, 'file_path' => 'songs/hatikoali.mp3', 'image_path' => 'media/hatikoali2.jpg', 'duration' => 178, 'genre_id' => $rap?->id],
            ['title' => 'Money Time', 'artist' => 'Hatikoali', 'artist_id' => $hatikoali?->id, 'file_path' => 'songs/hatikoali.mp3', 'image_path' => 'media/hatikoali3.jpg', 'duration' => 203, 'genre_id' => $rap?->id],
            ['title' => 'Dunya', 'artist' => 'Hatikoali', 'artist_id' => $hatikoali?->id, 'file_path' => 'songs/hatikoali.mp3', 'image_path' => 'media/hatikoali4.jpg', 'duration' => 187, 'genre_id' => $rap?->id],
            ['title' => '10/10', 'artist' => 'Hatikoali', 'artist_id' => $hatikoali?->id, 'file_path' => 'songs/hatikoali.mp3', 'image_path' => 'media/hatikoali5.jpg', 'duration' => 165, 'genre_id' => $rap?->id],
            ['title' => 'NPCs', 'artist' => 'Hatikoali', 'artist_id' => $hatikoali?->id, 'file_path' => 'songs/hatikoali.mp3', 'image_path' => 'media/hatikoali6.jpg', 'duration' => 221, 'genre_id' => $rap?->id],
            ['title' => 'Alyp Kepte', 'artist' => 'Hatikoali', 'artist_id' => $hatikoali?->id, 'file_path' => 'songs/hatikoali.mp3', 'image_path' => 'media/hatikoali7.jpg', 'duration' => 198, 'genre_id' => $rap?->id],
            ...
            ['title' => 'Yolla', 'artist' => 'Tarkan', 'artist_id' => $tarkan?->id, 'file_path' => 'songs/tarkan.mp3', 'image_path' => 'media/tarkan1.jpg', 'duration' => 207, 'genre_id' => $pop?->id],
            ['title' => 'Kuzu Kuzu', 'artist' => 'Tarkan', 'artist_id' => $tarkan?->id, 'file_path' => 'songs/tarkan.mp3', 'image_path' => 'media/tarkan2.jpg', 'duration' => 219, 'genre_id' => $pop?->id],
            ['title' => 'Dedikodu', 'artist' => 'Tarkan', 'artist_id' => $tarkan?->id, 'file_path' => 'songs/tarkan.mp3', 'image_path' => 'media/tarkan3.jpg', 'duration' => 192, 'genre_id' => $pop?->id],
            ['title' => 'Gun gibi', 'artist' => 'Tarkan', 'artist_id' => $tarkan?->id, 'file_path' => 'songs/tarkan.mp3', 'image_path' => 'media/tarkan4.jpg', 'duration' => 245, 'genre_id' => $pop?->id],
